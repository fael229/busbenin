  ...
  const loadTrajetDetails = async () => {
    try {
      ...
      const { data: trajetRow, error: trajetError } = await supabase
        .from("trajets")
        .select(
          "id, depart, arrivee, prix, horaires, gare, note, nb_avis, compagnies:compagnie_id(nom)"
        )
        .eq("id", id)
        .single();
    ...
    <View style={{ flex: 1, backgroundColor: "#F9FAFB" }}>
      ...
      >
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 20 }}>
          ...
          >
            <Map size={18} color="#1E88E5" style={{ marginRight: 8 }} />
            <Text
              style={{
                fontSize: 16,
                fontWeight: "600",
            ...
            {showReviewForm && (
              ...
              >
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewReview({ ...newReview, utilisateur: text })
                  }
                />
                ...
                >
                  <Text
                    style={{ fontSize: 14, color: "#374151", marginRight: 12 }}
                  >
                    Note:
                  </Text>
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <Star
                        ...
                        color="#F59E0B"
                        fill={
                          star <= newReview.note ? "#F59E0B" : "transparent"
                        }
                      />
                    </TouchableOpacity>
                  ))}
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewReview({ ...newReview, commentaire: text })
                  }
                />
