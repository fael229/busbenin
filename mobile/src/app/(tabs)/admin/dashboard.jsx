...
import { Building2, Users, MapPinPlus, Shield, Calendar, Car } from 'lucide-react-native';
          ...
          <View style={{ paddingHorizontal: 20 }}>
            ...
            {isAdmin && (
              ...
              >
                ...
                <View style={{ marginLeft: 12, flex: 1 }}>
                  <Text style={{ fontSize: 16, fontWeight: '600', color: '#1F2937' }}>Gestion Location</Text>
                  <Text style={{ fontSize: 12, color: '#6B7280', marginTop: 2 }}>Véhicules et réservations</Text>
                </View>
              </TouchableOpacity>
            )}
