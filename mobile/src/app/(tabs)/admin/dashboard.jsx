      ...
      >
        ...
        {!isAdmin && !isCompagnie ? (
          ...
          <View style={{ paddingHorizontal: 20 }}>
            ...
            {/* Location - Admin uniquement */}
            {isAdmin && (
              <TouchableOpacity
                onPress={() => router.push("/(tabs)/admin/manage-locations")}
                activeOpacity={0.8}
                style={{
                  backgroundColor: "#FFFFFF",
                  borderRadius: 12,
            ...
            {isAdmin && (
              <TouchableOpacity
                onPress={() => router.push("/(tabs)/admin/manage-wallets")}
                activeOpacity={0.8}
                style={{
                  backgroundColor: "#FFFFFF",
                  borderRadius: 12,
              ...
              >
                ...
                <View style={{ marginLeft: 12, flex: 1 }}>
                  ...
                  <Text
                    style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}
                  >
                    Retraits et soldes utilisateurs
                  </Text>
                </View>
              </TouchableOpacity>
            )}
            ...
            >
              ...
              <View style={{ marginLeft: 12, flex: 1 }}>
                ...
                >
                  {isCompagnie
                    ? "Gérer mes trajets"
                    : "Gérer les compagnies et trajets"}
                </Text>
                <Text style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}>
                  {isCompagnie
                    ? "Vos trajets, horaires, prix"
                    : "Ajout de trajets, modification, suppression"}
                </Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={{ marginLeft: 12, flex: 1 }}>
                ...
                <Text style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}>
                  {isCompagnie
                    ? "Réservations de vos trajets"
                    : "Voir, vérifier et gérer toutes les réservations"}
                </Text>
              </View>
            </TouchableOpacity>
          </View>
