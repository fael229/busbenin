...
export default function ManageCompagnies() {
  ...
  const [compagnieForm, setCompagnieForm] = useState({
    id: null,
    nom: "",
    logo_url: "",
    telephone: "",
  ...
  const loadCompagnies = async () => {
    const { data, error } = await supabase
      .from("compagnies")
      .select("id, nom, logo_url, telephone, created_at")
      .order("nom");
    if (error) {
  ...
  const addTrajet = async () => {
    ...
    if (
      ...
      !payload.arrivee ||
      !payload.prix ||
      !payload.compagnie_id
    )
      return;
    try {
      const { error } = await supabase.rpc("admin_upsert_trajet", {
        p_depart: payload.depart,
        p_arrivee: payload.arrivee,
        p_prix: payload.prix,
        p_compagnie_id: payload.compagnie_id,
      });
      if (error) throw error;
  ...
  const deleteTrajet = async (id) => {
    Alert.alert("Confirmer", "Supprimer ce trajet ?", [
      { text: "Annuler" },
      {
        ...
        onPress: async () => {
          try {
            const { error } = await supabase.rpc("admin_delete_trajet", {
              p_trajet_id: id,
            });
            if (error) throw error;
            ...
            >
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    activeTab === "compagnies" ? "#1E88E5" : "transparent",
                }}
              >
                <Text
                  style={{
                    textAlign: "center",
                    fontWeight: "600",
                    color: activeTab === "compagnies" ? "#FFFFFF" : "#6B7280",
                  }}
                >
                  Compagnies
                </Text>
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    activeTab === "trajets" ? "#1E88E5" : "transparent",
                }}
              >
                <Text
                  style={{
                    textAlign: "center",
                    fontWeight: "600",
                    color: activeTab === "trajets" ? "#FFFFFF" : "#6B7280",
                  }}
                >
                  Trajets
                </Text>
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {compagnies.length === 0 && (
              ...
              >
                ...
                >
                  Aucune compagnie. Cliquez sur "Ajouter" pour créer la
                  première.
                </Text>
              </View>
            )}
                ...
                >
                  {compagnies.map((c) => (
                    <TouchableOpacity
                      ...
                      style={{
                        backgroundColor:
                          selectedCompagnie === c.id ? "#1E88E5" : "#FFFFFF",
                        borderRadius: 12,
                        padding: 12,
                        marginRight: 8,
                        borderWidth: 1,
                        borderColor:
                          selectedCompagnie === c.id ? "#1E88E5" : "#E5E7EB",
                      }}
                    >
                      <Text
                        style={{
                          color:
                            selectedCompagnie === c.id ? "#FFFFFF" : "#111827",
                          fontWeight: "600",
                        }}
                      >
                        {c.nom}
              ...
              <View style={{ paddingHorizontal: 16, marginBottom: 12 }}>
                ...
                >
                  <TextInput
                    placeholder="Départ"
                    value={form.depart}
                    onChangeText={(t) => setForm((f) => ({ ...f, depart: t }))}
                    style={{
                      borderWidth: 1,
                      borderColor: "#E5E7EB",
                      borderRadius: 8,
                  ...
                  <TextInput
                    placeholder="Arrivée"
                    value={form.arrivee}
                    onChangeText={(t) => setForm((f) => ({ ...f, arrivee: t }))}
                    style={{
                      borderWidth: 1,
                      borderColor: "#E5E7EB",
                      borderRadius: 8,
                  ...
                  <TextInput
                    ...
                    value={form.prix}
                    onChangeText={(t) => setForm((f) => ({ ...f, prix: t }))}
          ...
          >
            ...
            <ScrollView style={{ maxHeight: 400, paddingHorizontal: 20 }}>
              ...
              <TextInput
                ...
                onChangeText={(t) =>
                  setCompagnieForm((f) => ({ ...f, telephone: t }))
                }
              ...
              <TextInput
                ...
                onChangeText={(t) =>
                  setCompagnieForm((f) => ({ ...f, logo_url: t }))
                }
                autoCapitalize="none"
                style={{
                  borderWidth: 1,
